...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('shop_simplevariations_option', 'name')

        # Deleting field 'OptionGroup.description'
        db.delete_column('shop_simplevariations_optiongroup', 'description')

        # Deleting field 'OptionGroup.name'
        db.delete_column('shop_simplevariations_optiongroup', 'name')
    ...
    def backwards(self, orm):
        ...
        db.add_column('shop_simplevariations_optiongroup', 'description', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)
